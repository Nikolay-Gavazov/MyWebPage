      ...
      <section className="about-page">
        <div className="about-wrapper flex justify-center gap-36">
          ...
          <section className="content max-w-3xl">
            <h1 className="text-[#ffb000] text-4xl mb-1 text-center">
              About Me
            </h1>
            ...
            <div className="text-wrapper flex gap-8">
              ...
              <div className="flex flex-col items-center flex-1">
                ...
                <p className="text-white text-center mt-5">
                  ...
                  indulging in my hobbies. I have a deep love for cars, often
                  spending my weekends tinkering under the hood or hitting the
                  open road. Football matches are a must-watch for me, and I
                  never say no to a thrilling off-road adventure or a karting
                  session.
                </p>
              </div>
            </div>
            <div className="text-wrapper flex gap-8">
              <div className="flex flex-col items-center flex-1">
                ...
                <p className="text-white text-center mt-5">
                  ...
                  it comes to design, I turn to Figma to bring my ideas to life,
                  and for mobile app development, I rely on Ionic.
                </p>
              </div>
              <div className="flex flex-col items-center flex-1">
                ...
                <p className="text-white text-center mt-5">
                  ...
                  privilege of working on projects that span across cultures and
                  continents. My diverse experiences have not only enriched my
                  skill set but also broadened my perspective on problem-solving
                  and collaboration.
                </p>
              </div>
            </div>
            ...
            <p className="text-white text-center mt-5">
              ...
              I'm always up for a stimulating conversation. Feel free to reach
              out and let's embark on this exciting journey together!
            </p>
          </section>
        </div>
      </section>

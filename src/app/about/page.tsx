    ...
    <>
      <section className="">
        <div className="flex justify-center gap-36">
          ...
          <h3 className="text-white mt-5">A Bit About My Journey</h3>
          <p className="text-white mt-5">
          ...
          <div className="flex flex-col items-center flex-1">
          <h3 className="text-white mt-5">My Passions</h3>
          <p className="text-white mt-5">
          ...
          <h3 className="text-white mt-5">My Toolbox</h3>
          <p className="text-white mt-5">
          ...
          <h3 className="text-white mt-5">Experience Beyond Borders</h3>
          <p className="text-white mt-5">
          ...
          <h3 className="text-white mt-5">Let's Connect</h3>
          <p className="text-white mt-5">
